...
class SessionWrapper
{
	...
	public static function setSession($p_session_key, $p_session_value_to_set)
	{
	...
	public static function getSession($p_session_key)
	{
	...
	public static function unsetSession($p_session_key)
	{
